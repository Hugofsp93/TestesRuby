...
//= require template/autosize
//= require template/bloodhound
//= require template/moment.min
//= require template/bootstrap-datetimepicker.min
//= require template/bootstrap-growl
//= require template/bootstrap-select
//= require template/chosen.jquery
//= require select2
// require template/detect-zoom
//= require template/excanvas
//= require template/farbtastic
//= require template/fileinput
//= require template/fullcalendar
//= require template/gcal
//= require template/input-mask
//= require template/jquery.bootgrid
//= require template/jquery.bootgrid.fa
//= require template/jquery.bootstrap.wizard
//= require template/jquery.colorhelpers
//= require template/jquery.easypiechart
//= require template/jquery.mCustomScrollbar
//= require template/jquery.mousewheel
//= require template/jquery.nouislider.all
// require template/jquery.nouislider
...
$(document).ready(function(){
    ...
    $("select").change(function (e) {
      var sel = e.target;
      if (sel.value == "") {
        $(sel.parentElement).removeClass("fg-toggled-manual");
      } else {
        $(sel.parentElement).addClass("fg-toggled-manual");
      }
    });
    // $(".fancybox").fancybox();
    $("select").select2({ width: '100%' });
    // $("select").chosen({placeholder_text_single:"Selecione uma opção", no_results_text:"Nenhum resultado para"});
});
...
$(document).ready(function(){
    ...
    (function () {
        ...
        if($("#sidebar")[0] && !$('#header-2')[0]) {  //Make it work only on normal headers
            // if (layoutStatus == 1) {
